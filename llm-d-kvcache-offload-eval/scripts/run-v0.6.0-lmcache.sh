...
# LMCache benchmarks for llm-d v0.6.0 at default gpu_memory_utilization=0.9.
# Uses lmcache/vllm-openai:v0.4.2 (released 2026-03-17, targets vLLM 0.17.x).
# Mirrors run-v0.5.1-lmcache.sh for version comparison.
...
echo ""
echo "=========================================="
echo "v0.6.0 lmcache benchmarks complete!"
