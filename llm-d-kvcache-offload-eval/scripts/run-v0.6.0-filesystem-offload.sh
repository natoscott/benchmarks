...
# Wheel must be pre-staged on model-storage-pvc at /data/llmd_fs_connector-0.7.1-cp312-cp312-linux_x86_64.whl
...
# Staged on model-storage-pvc as /data/llmd_fs_connector-0.7.1-cp312-cp312-linux_x86_64.whl
