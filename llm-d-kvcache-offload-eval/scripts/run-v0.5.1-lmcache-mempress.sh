...
# lmcache benchmarks for llm-d v0.5.1 at reduced gpu_memory_utilization
# (memory-pressure conditions matching run-v0.5.1-mempress.sh).
...
for replicas in ${REPLICAS}; do
    ...
    for model in ${MODELS}; do
        ...
        # Per-model gpu_memory_utilization (matched to run-v0.5.1-mempress.sh)
        case "${MODEL_NAME}" in
...
echo ""
echo "=========================================="
echo "v0.5.1 lmcache mempress benchmarks complete!"
